...
class KerasModel:
    def __init__(self, single_frame_model_loc, multi_frame_model_loc):
        self.single_frame_model = model.single_frame_model()
        self.multi_frame_model = model.multi_frame_model(num_frames=7)
        self.single_frame_model.load_weights(single_frame_model_loc, by_name=True)
        self.multi_frame_model.load_weights(multi_frame_model_loc, by_name=True)
